...
public class QueryEngineV {
     ...
     * @param params parameters to replace params in the query. E.g., if you have a pair of string "pou" & "T_Pump", it
     *        will replace all ?pou with string "T_Pump"
    ...
    /**
     * If resource is an individual (i.e., instance of class), show list of its properties
     * 
     * @param instance
     */
    ...
    /**
     * Read query from a file, omit comments (and printed it out), and put it in a ParameterizedSparqlString.
     * 
     * @param qString
     * @param fileName
     */
    ...
    /**
     * The real execution of the query. Put the result directly to the outstream that is defined in the setOutput()
     * method.
     * 
     * @param fileName
     * @param qString
    ...
    /**
     * It is possible to put parameter to the query using this function. The parameters should be structured as a Map.
     * 
     * @param qString
     * @param params
     */
    ...
    /**
     * 
     * If there is rule file associated with the ontology, this function execute the rule file (and maybe built-in
     * reasoner) to calculate the resulted facts.
     * 
     * @param ruleFile
     */
